...
<body>
	<nav class="navbar navbar-expand-md navbar-light fixed-top bg-warning" id="navAd">
		<a class="navbar-brand" href="#">
			<img src="<?php echo base_url();?>img/logo.png" height="40px" width="90px" class="" style="padding: 0px;" />
		</a>
	...
	<main role="main" class="container">
		<div class="row">
			...
			<div class="col-3 offset-4">
				<button id="btnAgregarAlumno" value="" class="btn btn-success" data-toggle="modal" data-target="#InsertAlumnos">Agregar
					alumno</button>
