...
<html lang="es">
  <head>
    ...
    <link href="<?php echo base_url();?>lib/css/product.css" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <nav class="site-header sticky-top py-1">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <a class="py-2 d-none d-md-inline-block" href="<?php echo site_url();?>/CVL">Ingresar al sistema</a>
      </div>
    </nav>

    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        <h1 class="display-4 font-weight-normal">SAAC Movil</h1>
        <p class="lead font-weight-normal">Una pequeña ayuda a la labor del docente</p>
        <a class="btn btn-outline-secondary" href="#">Proximamente...</a>
      </div>
      <div class="product-device box-shadow d-none d-md-block"><img src="<?php echo base_url();?>img/VistMock1.png" class="img-thumbnail" ></div>
      <div class="product-device product-device-2 box-shadow d-none d-md-block"><img src="<?php echo base_url();?>img/VistMock2.png" class="img-thumbnail" ></div>
    </div>
    ...
    <script src="<?php echo base_url();?>lib/js/holder.min.js"></script>
    <script>
