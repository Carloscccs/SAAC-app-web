...
En caso de que requiera la version de para un sistema operativo diferente de windows
...
No hay restriccion para el tipo de herramienta, se puede utilizar la que le sea mas comoda, ya sea:
    ...
    - NetBeans: https://netbeans.org/ (cuidado con el codigo extra que genera el IDE)
